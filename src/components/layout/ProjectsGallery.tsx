...
import { SiC, SiPython, SiCplusplus, SiLinux, SiTensorflow } from "react-icons/si";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 items-stretch">
        {projects.map((project) => (
          <a
            ...
            className="group border border-gray-700 rounded-lg overflow-hidden p-4 hover:shadow-lg transition flex flex-col h-50"
          >
            {project.image && (
              <img
                src={project.image}
